...
namespace Emgu.CV
{
   ...
   /// OpenCV And FisherFace Teq Attempt 1
   /// </summary>
   [Serializable]
   public class EigenObjectRecognizer
   {
      ...
      /// </summary>
      /// <param name="images">The images used for training, each of them should be the same size.
      /// It's recommended the images are histogram normalized</param>
